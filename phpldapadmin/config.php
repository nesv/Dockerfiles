...
$servers->setValue('server','name','Lapdog LDAP server');
...
$servers->setValue('server','base',array('dc=auth,dc=lapdog,dc=so'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=auth,dc=lapdog,dc=so');
#  $servers->setValue('login','bind_id','cn=Manager,dc=example,dc=com');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
// $servers->setValue('login','bind_pass','');
$servers->setValue('login','bind_pass','adminpass');
